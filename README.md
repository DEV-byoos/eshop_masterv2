...
## eshop_masterv2 web-based from Shopping Cart Solution and codeIgniter 3.1.10 and PHP 7.3  auth BCRYP build to eshop_masterv2 version 2.0  BYOOS solutions  http://byoos.net
